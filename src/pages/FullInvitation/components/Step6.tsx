...
const Step6: React.FC = () => {
  const mapUrl = "https://www.google.com/maps/place//data=!4m2!3m1!1s0x8e89984a60e08973:0xb8c14b5a526a3ec1?sa=X&ved=1t:8290&ictx=111";
  ...
  return (
    ...
    >
      {/* Marco dorado alrededor de todo el contenido */}
      <Box
        sx={{
          position: 'absolute',
          top: '20px',
